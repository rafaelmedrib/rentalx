...
let AuthenticateUserUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const passwordMatches = await (0, _bcryptjs.compare)(password, user.password);
    ...
    const refresh_token_expiration_date = this.dateProvider.addDays(expires_in_refresh_token_days);
