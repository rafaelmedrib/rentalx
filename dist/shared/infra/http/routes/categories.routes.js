...
categoriesRoutes.route("/").post(_ensureAuthenticated.ensureAuthenticated, _ensureAdmin.ensureAdmin, createCategoryController.handle).get(listCategoriesController.handle);
